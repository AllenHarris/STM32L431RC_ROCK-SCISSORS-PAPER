...
#ifndef __AI_NETWORK_CNN_H__
#define __AI_NETWORK_CNN_H__
#pragma once

#include "ai_platform.h"

#define AI_NETWORK_CNN_MODEL_NAME          "network_cnn"

#define AI_NETWORK_CNN_IN_NUM       (1)
#define AI_NETWORK_CNN_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 32, 32, 3, 1, NULL), \
}
#define AI_NETWORK_CNN_IN_SIZE { \
  (32 * 32 * 3), \
}
#define AI_NETWORK_CNN_IN_1_SIZE  (32 * 32 * 3)
#define AI_NETWORK_CNN_IN_1_SIZE_BYTES  ((32 * 32 * 3) * 4)




#define AI_NETWORK_CNN_OUT_NUM      (1)
#define AI_NETWORK_CNN_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_NETWORK_CNN_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_NETWORK_CNN_OUT_1_SIZE  (1 * 1 * 3)
#define AI_NETWORK_CNN_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_cnn
 ...
 * @ref ai_network_cnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_cnn_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_CNN_*
 * defines into file @ref network_cnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_cnn_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_NETWORK_CNN_H__*/
